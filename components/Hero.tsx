...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-24 pb-20 md:pt-28 md:pb-20">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <div className="relative inline-block">
          ...
          <h1 className="relative mb-6 inline-block rounded-lg border border-white/20 bg-white/15 px-6 py-3 text-4xl font-bold tracking-tight text-white shadow-[inset_0_1px_0_0_rgba(255,255,255,0.25)] backdrop-blur-md sm:text-5xl md:text-6xl">
            {user.name}
          </h1>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-base">
          {user.companyName && (
            <a
              ...
              className="group flex items-center gap-2 rounded-xl border border-white/20 bg-white/15 px-4 py-2 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2)] backdrop-blur-md transition-all hover:border-white/30 hover:bg-white/25 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_0_20px_rgba(34,211,238,0.3)]"
            >
              <img
                src={JUST_EAT_FAVICON}
                alt=""
          ...
          <a
            href="https://www.google.com/maps/place/Bristol,+UK"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 rounded-xl border border-white/20 bg-white/15 px-4 py-2 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2)] backdrop-blur-md transition-all hover:border-white/30 hover:bg-white/25 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_0_20px_rgba(34,211,238,0.3)]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex cursor-pointer items-center gap-2 rounded-xl border border-white/20 bg-white/15 px-4 py-2 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2)] backdrop-blur-md transition-all hover:border-white/30 hover:bg-white/25 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_0_20px_rgba(34,211,238,0.3)]"
          >
            <svg className="h-5 w-5 fill-white drop-shadow-md" viewBox="0 0 24 24">
